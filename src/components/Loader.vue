<template>
  <div
    style="position: absolute;top: 0;bottom: 0;left: 0;right: 0;background: #555;opacity: .5;z-index: 998;"
    class="loading"
  >
    <svg
      style="position: absolute;height: 70%;max-height: 90px;margin: auto;top: 0;bottom: 0;left: 0;right: 0;z-index: 999;"
      version="1.1"
    ...
    >
      ...
      <path
        ...
        transform="rotate(-221.919 50 50)"
      >
        <animateTransform
          attributeName="transform"
          attributeType="XML"
